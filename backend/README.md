...
## Project Structure
    ...
    ├── ideapros_llc_everla_32432  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_everla_32432`
...
2. Clone this repo and `cd ideapros_llc_everla_32432`
